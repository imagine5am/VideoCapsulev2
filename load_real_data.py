...
class ExternalTestDataLoader():
    def __init__(self):
        ...
        self.icdar_gen = ICDAR_Gen(split_type='test', data_queue_length=10)
        self.yvt_gen = YVT_Gen(split_type='test', data_queue_length=6)
...
class ExternalTrainDataLoader():
    def __init__(self):
        ...
        self.icdar_gen = ICDAR_Gen(data_queue_length=8, sec_to_wait=10)
        self.yvt_gen = YVT_Gen(data_queue_length=6)
